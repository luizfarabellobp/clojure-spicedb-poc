...
> Artigo 2 de 4. O artigo 1 explica as ideias gerais (ReBAC, ABAC,
...
> explicam os arquivos de configuração (3) e como os dados ficam
> guardados no Postgres (4). A collection do Postman
